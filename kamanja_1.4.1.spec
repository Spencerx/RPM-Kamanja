...
sudo ln -s $RPM_INSTALL_PREFIX/kamanja_1.4.1_2.11/ /usr/bin/kamanja
echo "$RPM_INSTALL_PREFIX/kamanja_1.4.1_2.11" >> /tmp/kamanja_vers.temp

%postun
[ -L /usr/bin/kamanja ]  && rm -f /usr/bin/kamanja || echo "File Not Found" >> $RPM_INSTALL_PREFIX/rpm.log
[ -d $RPM_INSTALL_PREFIX/kamanja_1.4.1_2.11 ]  && rm -r $RPM_INSTALL_PREFIX/kamanja_1.4.1_2.11 || echo "Dir Not Found" >> $RPM_INSTALL_PREFIX/rpm.log
